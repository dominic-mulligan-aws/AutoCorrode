...
object ActionHelper {
  ...
  def runAsync(
    name: String,
    status: String = CopilotConstants.STATUS_THINKING
  )(body: => String)(
    ...
    CopilotDockable.setStatus(status)
  ...
  def runAndRespond(name: String, status: String = CopilotConstants.STATUS_THINKING)(body: => String): Unit =
