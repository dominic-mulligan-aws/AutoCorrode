...
object InsertHelper {
   ...
   * @return Action callback suitable for CopilotDockable.registerAction
   */
  ...
  /**
   * Create an insert action and register it with CopilotDockable.
  ...
  def registerInsertAction(view: View, code: String): String = {
    CopilotDockable.registerAction(createInsertAction(view, code))
  }
}