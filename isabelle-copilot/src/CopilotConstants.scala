...
/**
 * Configuration constants for Isabelle Copilot operations.
 *
 * Timeout values are in milliseconds unless noted otherwise.
 * These provide sensible defaults; most can be overridden via CopilotOptions.
 */
object CopilotConstants {
