...
enum ToolId(val wireName: String) {
  ...
  case GetFileStats extends ToolId("get_file_stats")
  case GetProcessingStatus extends ToolId("get_processing_status")
  case GetSorryPositions extends ToolId("get_sorry_positions")
